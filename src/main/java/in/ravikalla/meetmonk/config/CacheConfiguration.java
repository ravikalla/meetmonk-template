package in.ravikalla.meetmonk.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, in.ravikalla.meetmonk.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, in.ravikalla.meetmonk.repository.UserRepository.USERS_BY_EMAIL_CACHE);
