...
import { AppointmentsComponent } from 'app/entities/appointments/appointments.component';
...
describe('Component Tests', () => {
  describe('Appointments Management Component', () => {
    let comp: AppointmentsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AppointmentsComponent, '')
        .compileComponents();
