...
import in.ravikalla.meetmonk.config.audit.AuditEventConverter;
import in.ravikalla.meetmonk.domain.PersistentAuditEvent;
...
import static in.ravikalla.meetmonk.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
